...
//Function to implement Resource Request algorithm
...
//Function to implement Safety algorithm
...
void accept(int A[][10],int N[][10],int M[10][10],int W[1][10],int *n,int *m){
	...
	printf("\n Allocation Matrix");  //printing allocation matrix
	print(A,*n,*m);
	printf("\n Maximum Requirement Matrix");  //printing MAX matrix
	print(M,*n,*m);
	printf("\n Need Matrix");  // printing need matrix
	print(N,*n,*m);
